...
from models.head import create_res_basic_head, create_res_roi_pooling_head
from models.net import DetectionBBoxNetwork, Net
from models.stem import (
...
def create_res_stage(
    *,
    ...
    bottleneck: Callable,
    # Conv configs.
    conv_a_kernel_size: Union[Tuple[int], List[Tuple[int]]] = (1, 1, 1),
    conv_a_stride: Tuple[int] = (1, 1, 1),
    conv_a_padding: Union[Tuple[int], List[Tuple[int]]] = (0, 0, 0),
    conv_a: Callable = nn.Conv3d,
    conv_b_kernel_size: Tuple[int] = (3, 3, 3),
    conv_b_stride: Tuple[int] = (2, 2, 2),
    conv_b_padding: Tuple[int] = (1, 1, 1),
...
def create_resnet(
    *,
    ...
    # Stem configs.
    stem_dim_out: int = 64,
    stem_conv_kernel_size: Tuple[int] = (7, 7, 7),
    stem_conv_stride: Tuple[int] = (2, 2, 2),
    stem_pool: Callable = nn.MaxPool3d,
    stem_pool_kernel_size: Tuple[int] = (3, 3, 3),
    stem_pool_stride: Tuple[int] = (2, 2, 2),
    stem: Callable = create_res_basic_stem,
    # Stage configs.
    stage1_pool: Callable = None,
    stage1_pool_kernel_size: Tuple[int] = (1, 1, 1),
    ...
    torch._C._log_api_usage_once(".model.create_resnet")
