...
from models.resnet import create_resnet, create_resnet_with_roi_head
...
root_dir = "https://dl.fbaipublicfiles.com//model_zoo"
checkpoint_paths = {
...
def slow_r50(
    ...
    Args:
        ...
        kwargs: use these to modify any of the other model settings. All the
            options are defined in /models/resnet.py
